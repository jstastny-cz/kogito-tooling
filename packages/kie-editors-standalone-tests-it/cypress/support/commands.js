...
Cypress.Commands.add("componentType", { prevSubject: "optional" }, (subject, type, criteria = "", options = {}) => {
  if (subject) {
...
Cypress.Commands.add("componentId", { prevSubject: "optional" }, (subject, id, criteria = "", options = {}) => {
  if (subject) {
